...
The hash/pound symbol (#) next to each previous guess will change to the color represented by your guess.

### Ending the game
The game ends when you have correctly guessed all the digits in the hexcode (all the tiles are green) or you have exhausted all of your guesses (in limited guessing mode). You will see the answer, how many guesses you used, and a small representation of your attempts.
You may start a new game by clicking the Play Again button.

### Features
There is a three icon toolbar under the title which link to game information, extra information, and settings popups. Game information explains the rules of the game, extra information elaborates on hexcodes, and settings allows you to set the color mode of the page and the game mode.
